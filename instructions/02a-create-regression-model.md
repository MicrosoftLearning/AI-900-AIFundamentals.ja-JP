...
1. **[設定]** ペインの右上の "閉じる" アイコンを選択して、ペインを閉じます。** 
...
1. Azure Machine Learning スタジオで、画面の左上にあるメニュー アイコンを選択して左側のペインを展開します。 **[ジョブ]** (**[資産]** の下) をクリックして、実行したすべてのジョブを表示します。 実験 **[mslearn-auto-training]** を選択し、**[mslearn-auto-training]** パイプラインを選択します。 
